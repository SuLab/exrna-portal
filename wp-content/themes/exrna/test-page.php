...
<div class="container">
	<div class="row">
		...
		<div class="col-md-8">
			<ul>
			<li><a id="allp">All Projects</a></li>
			<li><a id="dmrr">DMRR</a></li>
			<li><a id="function">Functions</a></li>
			<li><a id="biomarker">Biomarkers</a></li>
			<li><a id="therapy">Therapy</a></li>
			</ul>
		</div>
	</div>
	<div class="row">
	  
	  <div class="col-md-12 funded-projects">
	      <div class="fp dmrr">    
	          <table class="table table-responsive" summary="metabolomics  data repository and coordinating center (u01) rfa-rm-11-020">
	                        <tbody>
	                        <tr>
	                        ...
	                        <tr style="border:none;">
	                            ...
	                            <th style="border:none;">pi name</th>
	      ...
	      <div class="fp biomarker">
	                <table class="table table-responsive" summary="technology development to enable large scale metabolomics analyses (r01) rfa-rm-11-019">
	                      <tbody>
	                        <tr>
	                          <td colspan="3" style="border:none;">
	      ...
	      <div class="fp therapy">
	          <table class="table table-responsive" summary="development of courses or workshops in    metabolomics (r25) rfa-rm-11-018">
	            <tbody><tr>
	              <td colspan="3" style="border:none;">
...
$( "#allp" ).click(function() {
  $(".biomarker").slideDown( "slow" );
});
$( "#allp" ).click(function() {
  $(".therapy").slideDown( "slow" );
});
//Show DMRR Only
$( "#dmrr" ).click(function() {
  $(".dmrr").slideDown( "slow" );
...
$( "#dmrr" ).click(function() {
  $(".function").slideUp( "slow" );
});
$( "#dmrr" ).click(function() {
  $(".biomarker").slideUp( "slow" );
});
$( "#dmrr" ).click(function() {
  $(".therapy").slideUp( "slow" );
});
//Show Function Only
$( "#function" ).click(function() {
  $(".dmrr").slideUp( "slow" );
