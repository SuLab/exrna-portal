				...
				<div class="row pushtop the-projects">
					...
					<div class="col-md-6">
						<div class="row">
							...
							<div class="col-md-9 col-sm-10 col-xs-12">
								<h4><a href="<?php bloginfo( 'url' ); ?>/projects/genetic-models-exrna-communication/">Genetic Models for exRNA Communication <span class="l-more"><i class="fa fa-long-arrow-right"></i></span></a></h4>
				...
				<div class="row pushtop the-projects">
					<div class="col-md-6">
						<div class="row">
							...
							<div class="col-md-9 col-sm-10 col-xs-12">
								<h4><a href="<?php bloginfo( 'url' ); ?>/projects/exrna-biomarkers-human-glioma/" title="exrna biomarkers for human glioma">exRNA Biomarkers for Human Glioma <span class="l-more"><i class="fa fa-long-arrow-right"></i></span></a></h4>
		                        <h5>Bob S. Carter</h5>
				...
				<div class="row pushtop the-projects">
					...
					<div class="col-md-6">
						<div class="row">
							...
							<div class="col-md-9 col-sm-10 col-xs-12">
								<h4><a href="<?php bloginfo( 'url' ); ?>/projects/exrna-signatures-predict-outcomes-brain-injury/" title="exrna signatures predict outcomes after brain injury">exRNA Signatures Predict Outcomes After Brain Injury <span class="l-more"><i class="fa fa-long-arrow-right"></i></span></a></h4>
