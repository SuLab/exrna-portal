...
/**function _tk_scripts() {
	...
	wp_enqueue_style( '_tk-fontawesome', '//netdna.bootstrapcdn.com/font-awesome/4.0.1/css/font-awesome.css' );
	...
	wp_enqueue_script( '', '//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js' );
